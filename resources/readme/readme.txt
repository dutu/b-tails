...
A: Follow these steps: 1) Booted up the computer from this USB drive. 2) Choose "Places -> Persistent" 3) Check the file `passwords.txt`.

Q: Is there additional information stored on this memory stick/card?
A: Look on Persistent Storage and VeraCrypt encrypted partition.

Q: I want to know more information about how this memory stick/card can be used and how it's built.
